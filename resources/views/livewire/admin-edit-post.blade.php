                ...
                @elseif(!$showDiv)
                    <div class="bg-[#CAB2FE] h-full w-full">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div>
                                <p class="p-3.5 font-bold text-3xl">Edit Blog</p>
                            </div>
                        ...
                        <div class="px-10">
                            ...
                            <div class="bg-white  p-5 rounded-3xl">
                                ...
                                <form id="new_blog" action="/admin-update-post" method="post"
                                      enctype="multipart/form-data">

                                    {{ csrf_field() }}
                                    <div class="flex flex-row justify-evenly w-fit">
                                        <div class="w-2/5 flex flex-col pl-10">
                                            <input type="hidden" class="w-full" name="post_id"
                                                   value="{{session('post_id')}}">
                                            <input type="hidden" name="posted_by_id"
                                                   value="{{session('posted_by_id')}}">
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div class="relative">
                                                    <select
                                                        ...
                                                        @else
                                                            <option selected hidden>Draft</option>
                                                        @endif
                                                        <option>Live</option>
                                                        <option>Draft</option>
                                                    </select>
                                        ...
                                        <div class="w-3/5 flex flex-col">
                                            <div class="mb-6">
                                                ...
                                                <textarea class="description w-screen"
                                                          name="blog_content">{{session('content')}}</textarea>
