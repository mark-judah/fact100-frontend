                ...
                @elseif(!$showDiv)
                    <div class="bg-[#CAB2FE] h-full w-full">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div>
                                <p class="p-3.5 font-bold text-3xl">User Profile</p>
                            </div>
                        ...
                        <div class="px-10 pb-10">
                            ...
                            <div class="bg-white w-fit flex  p-5 rounded-3xl">
                                <div class="p-3.5">
                                    <a href="{{url('/admin-new-profile')}}">
                                        <img class="w-10 h-10 fill-white "
                                          src="/assets/images/tab-new-svgrepo-com.svg">
                                    </a>
                                </div>
                                <table class="table-auto  text-gray-400 border-separate space-y-6 text-sm">
                                    ...
                                    @foreach($profiles as $profile)
                                        ...
                                        <tr class="lg:text-black">
                                            ...
                                            <td class="px-4 py-2  font-medium border">{{$profile['name']}}</td>
                                            <td class="px-4 py-2  font-medium border">{{$profile['email']}}</td>
                                            <td class="px-4 py-2  font-medium border">{{$profile['role']}}</td>

                                            <td class="px-4 py-2  font-medium border w-100 h-100">
                                                <img class="object-contain" src="{{ url($url) }}uploads/avatars/{{$profile['avatar']}}">
                                            </td>
                                            <td class="px-4 py-2  font-medium border">{{date('F jS Y', strtotime($profile['created_at']))}}</td>
