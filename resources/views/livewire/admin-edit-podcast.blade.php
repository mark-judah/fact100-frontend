                ...
                @elseif(!$showDiv)
                    <div class="bg-[#CAB2FE] h-full w-full">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div>
                                <p class="p-3.5 font-bold text-3xl">Edit Podcast</p>
                            </div>
                        ...
                        <div class="px-10">
                            ...
                            <div class="bg-white  p-5 rounded-3xl">
                                ...
                                <form id="new_podcast" class="w-full max-w-lg" action="/update-podcast" method="post"
                                      enctype="multipart/form-data">

                                    {{ csrf_field() }}
                                    <input type="hidden" class="w-full" name="podcast_id"
                                           value="{{session('podcast_id')}}">
                                    <input type="hidden" name="posted_by"
                                           value="{{session('posted_by')}}">
                                    <div class="w-full">
                                        <div class="mb-6 w-full">
                                            ...
                                            <input type="text" id="title"
                                                   ...
                                                   name="podcast_title" value="{{session('title')}}" placeholder="Podcast Title"
                                                   required="">
                                        </div>
                                        ...
                                        <div class="mb-6 w-full">
                                            ...
                                            <input type="text" id="season"
                                                   class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-fit p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                                   name="podcast_season" value="{{session('season')}}" placeholder="Podcast Season"
                                                   required="">
                                        </div>
                                        ...
                                        <div class="mb-6 w-full">
                                            ...
                                            <input type="text" id="title"
                                                   class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-fit p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                                   name="podcast_episode" value="{{session('episode')}}" placeholder="Podcast Episode"
                                                   required="">
                                        </div>
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <div class="relative">
                                                <select
                                                    ...
                                                    <option selected hidden>{{session('category')}}</option>
                                                    <option>Tech</option>
