                ...
                @elseif(!$showDiv)
                    <div class="bg-[#CAB2FE] h-screen w-full pb-30">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div>
                                <p class="p-3.5 font-bold text-3xl">All Messages</p>
                            </div>
                                ...
                                <table class="table-auto  text-gray-400 border-separate space-y-6 text-sm">
                                    ...
                                    @foreach($messages as $message)
                                        ...
                                        <tr class="lg:text-black">
                                            ...
                                            <td class="px-4 py-2  font-medium border">{{$message['name']}}</td>
                                            <td class="px-4 py-2  font-medium border">{{$message['email']}}</td>
                                            <td class="px-4 py-2  font-medium border">{{$message['subject']}}</td>
                                            <td class="px-4 py-2  font-medium border">{{$message['message']}}</td>
                                            <td class="px-4 py-2  font-medium border">{{date('F jS Y', strtotime($message['created_at']))}}</td>
                                            <td class="px-4 py-2  font-medium border">
                                                <button class="rounded-3xl bg-blue-900">
                                                    <p class="text-white p-3.5">Reply <span><i
                                                                class="bi bi-reply fill-white"></i></span></p>
                                                </button>
                                            </td>
