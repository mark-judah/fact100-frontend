                ...
                @elseif(!$showDiv)
                    <div class="bg-[#CAB2FE] h-screen w-full pb-30">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div>
                                <p class="p-3.5 font-bold text-3xl">All Comments</p>
                            </div>
                            ...
                            <div class="bg-white flex justify-center p-5 rounded-3xl ">
                                <table class="table-auto  text-gray-400 border-separate space-y-6 text-sm">
                                    ...
                                    <tr class="rounded-3xl">
                                        ...
                                        <th class="px-4 py-2 ">Comment By</th>
                                    ...
                                    @foreach($comments as $comment)
                                        ...
                                        <tr class="lg:text-black">
                                            ...
                                            <td class="px-4 py-2  font-medium border">{{$comment['slug']}}</td>
                                            <td class="px-4 py-2  font-medium border">{{$comment['comment_by']}}</td>
                                            <td class="px-4 py-2  font-medium border">{{$comment['comment']}}</td>
                                            <td class="px-4 py-2  font-medium border">{{date('F jS Y', strtotime($comment['created_at']))}}</td>
