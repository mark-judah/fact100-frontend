                ...
                @elseif(!$showDiv)
                    <div class="bg-[#CAB2FE] h-full w-full">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div>
                                <p class="p-3.5 font-bold text-3xl">Edit Profile</p>
                            </div>
                        ...
                        <div class="px-10">
                            ...
                            <div class="bg-white  p-5 rounded-3xl">
                                ...
                                <form id="new_podcast" class="w-full max-w-lg" action="/admin-update-profile"
                                      method="post"
                                      enctype="multipart/form-data">

                                    {{ csrf_field() }}
                                    <input type="hidden" class="w-full" name="profile_id"
                                    ...
                                    <div class="w-full">
                                        <div class="mb-6 w-full">
                                            ...
                                            <input type="text" id="name"
                                                   ...
                                                   name="name" value="{{session('profile_name')}}" placeholder="User name"
                                                   required="">
                                        </div>

                                        <div class="mb-6 w-full">
                                            <label for="podcast season"
                                                   class="block mb-2 text-sm font-bold text-gray-900 dark:text-gray-300">Email</label>
                                            <input type="text" id="email"
                                                   class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-fit p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                                   name="email" value="{{session('profile_email')}}" placeholder="Email"
                                                   required="">
                                        </div>

                                        <div class="mb-6 w-full">
                                            <label for="episode"
                                                   class="block mb-2 text-sm font-bold text-gray-900 dark:text-gray-300">Role</label>
                                            <input type="text" id="role"
                                                   class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-fit p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                                   name="role" value="{{session('profile_role')}}" placeholder="Role"
                                                   required="">
                                        </div>
